<template>
    <div id="app">
        <custom-input v-model="inputValue" type="tel" :mask="'\\+7 (111) 1111-11'"/>
                ...
                navItems: [
                    {
                        to: '',
                        text: 'Линк 1',
                        icon: '<svg width="11" height="7" viewBox="0 0 10.5 6" xmlns="http://www.w3.org/2000/svg">\n' +
                            '<path fill-rule="evenodd" clip-rule="evenodd" d="M5.16436 3.40945L1.32873 0L0 1.49482L5.16436 6.08536L10.3287 1.49482L9 3.57628e-07L5.16436 3.40945Z" />\n' +
                            '</svg>',
                    },
                    {
                        to: '',
